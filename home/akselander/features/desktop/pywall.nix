      ...
      installPhase = ''
        ...
        ${
          ...
          then ''
            ...
            @import url(\"file:///${config.home.homeDirectory}/.config/wpg/templates/gtk.css\");" > ./linea-nord-color/general/dark.css
          ...
          else "rm ./linea-nord-color/dark.css.base"
        }
...
in {
  ...
  config = let
    theme = gtkTheme config.wal.enable;
  in
    lib.mkMerge [
      (
